TEXTS = {
    "ru": {
        ...
        "owner_greeting": "Здравствуйте, {name}! 👋",
        ...
        "approved_suffix": "\n\n✅ Одобрено",
        "rejected_suffix": "\n\n❌ Отклонено",
        "new_request_prefix": "🆕 Новая заявка на регистрацию оператора:\n\n",
    ...
    "uz": {
        ...
        "owner_greeting": "Assalomu alaykum, {name}! 👋",
        "pending_list_empty": "Yangi so'rovlar yo'q.",
        "pending_item": "👤 {name}\n📞 {phone}\nID: {tg_id}",
        "approve_btn": "✅ Tasdiqlash",
        "reject_btn": "❌ Rad etish",
        "not_available": "Mavjud emas",
        "already_processed": "So'rov allaqachon ko'rib chiqilgan",
        "operator_added": "Operator qo'shildi",
        "request_rejected": "So'rov rad etildi",
        "approved_suffix": "\n\n✅ Tasdiqlandi",
        "rejected_suffix": "\n\n❌ Rad etildi",
        "new_request_prefix": "🆕 Yangi operator ro'yxatdan o'tish so'rovi:\n\n",
